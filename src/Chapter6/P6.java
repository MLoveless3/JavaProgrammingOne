...
public class P6 {
    ...
    public static void main(String[] args)
	{
		...
		do
		{
			...
			switch(con)
			{
				case 'E' : converted = Convert(dollarAmount, euros);
							break;
							
				case 'P' : converted = Convert(dollarAmount, poundSterling);
							break;
							
				case 'Y' : converted = Convert(dollarAmount, yen);
							break;
			}
			...
			switch(con)
			{
				...
				case 'P' : System.out.printf("With $%.2f you can get %.2f in Pounds.\n", dollarAmount, converted);
							break;
							
				case 'Y' : System.out.printf("With $%.2f you can get %.2f in Yen.\n", dollarAmount, converted);
							break;
			}
     ...
     * @param type the type of currency the want to convert to
